...
let TraceabilityRequestModule = class TraceabilityRequestModule {
};
TraceabilityRequestModule = __decorate([
    NgModule({
        declarations: [
...
export { TraceabilityRequestModule };
//# sourceMappingURL=traceability-request.module.js.map