...
let TraceabilityUploadModule = class TraceabilityUploadModule {
};
TraceabilityUploadModule = __decorate([
    NgModule({
        declarations: [
...
], TraceabilityUploadModule);
export { TraceabilityUploadModule };
//# sourceMappingURL=traceability-upload.module.js.map