    ...
    registerUser(userRegistrationFormValue) {
        ...
        this.angularTokenService.registerAccount({
            ...
            next: (response) => {
                ...
                // store user
                if ((_a = response.user) === null || _a === void 0 ? void 0 : _a.data) {
                    this.userStorageService.storeUser(response);
                }
                // store company
                if ((_b = response.company) === null || _b === void 0 ? void 0 : _b.data) {
    ...
    signInUser(userSignInFormValue, otp = '0') {
        ...
        this.angularTokenService.signIn({
            ...
            next: (response) => {
                ...
                if (this.userStorageService.isUserConfirmed() === false && ((_c = response.user) === null || _c === void 0 ? void 0 : _c.data.attributes.signInCount) > 1) {
