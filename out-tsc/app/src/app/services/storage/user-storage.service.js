...
let UserStorageService = class UserStorageService {
    ...
    storeUser(object) {
        var _a, _b, _c, _d;
        // set attributes
        const attributes = (_b = (_a = object.user) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.attributes;
        this.localStorage.store(GlobalConstants.userId, (_d = (_c = object.user) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.id);
